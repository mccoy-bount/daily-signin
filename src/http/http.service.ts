...
export class HttpService {
   ...
   * @description 云图8签到
   */
  async checkInRequestByYunTu8(): Promise<{
    statusCode: number
    data: any
    success: boolean
    error?: string
